...
# As we can see, the traceback highlights that the error occurs in the function
# named f3, i.e. the last call in the stack.
...
# Now let's quit the debug environment and suppose we define a variable named
# "x" in the global environment and we assign to it value 1.
...
# 5. And if I cannot debug my problem ? :( --------------------------------
