...
1. Elements of Object-Oriented (OO) programming with R [@wickham2019advanced] applied to R packages development (2h). We will focus on the S3 system.
...
1. create an R package that answers a simple statistical problem, providing the necessary testing and documentation. The R package must be published on Github and it will be reviewed following the guidelines of the rOpenSci community: <https://github.com/ropensci/software-review>. 
